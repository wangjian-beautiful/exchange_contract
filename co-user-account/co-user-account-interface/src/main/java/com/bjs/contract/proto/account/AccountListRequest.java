...
/**
 * Protobuf type {@code account.AccountListRequest}
 */
public  final class AccountListRequest extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:account.AccountListRequest)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return AccountBizServiceProto.internal_static_account_AccountListRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return AccountBizServiceProto.internal_static_account_AccountListRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AccountListRequest.class, Builder.class);
  }
  ...
  public static AccountListRequest parseFrom(
  ...
  public static AccountListRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static AccountListRequest parseFrom(
  ...
  public static AccountListRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static AccountListRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static AccountListRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(AccountListRequest prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:account.AccountListRequest)
      AccountListRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return AccountBizServiceProto.internal_static_account_AccountListRequest_descriptor;
    ...
    // Construct using com.bjs.contract.proto.account.AccountListRequest.newBuilder()
    private Builder() {
    ...
    @Override
    public AccountListRequest getDefaultInstanceForType() {
      return AccountListRequest.getDefaultInstance();
    }

    @Override
    public AccountListRequest build() {
      AccountListRequest result = buildPartial();
    ...
    @Override
    public AccountListRequest buildPartial() {
      AccountListRequest result = new AccountListRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof AccountListRequest) {
        return mergeFrom((AccountListRequest)other);
      } else {
    ...
    public Builder mergeFrom(AccountListRequest other) {
      if (other == AccountListRequest.getDefaultInstance()) return this;
      if (accountPOBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      AccountListRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (AccountListRequest) e.getUnfinishedMessage();
    ...
    // @@protoc_insertion_point(builder_scope:account.AccountListRequest)
  }

  // @@protoc_insertion_point(class_scope:account.AccountListRequest)
  private static final AccountListRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AccountListRequest();
  }
