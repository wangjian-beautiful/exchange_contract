...
import com.bijinsuo.common.utils.file.FileUploadUtils;
import com.bijinsuo.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController {
    ...
    @ResponseBody
    public AjaxResult resetGoogleSecretKey() {
        SysUser user = getSysUser();
        if (userService.clearGoogleSecretKey(user.getUserId())) {
            return success();
        }
        return error();
    }
